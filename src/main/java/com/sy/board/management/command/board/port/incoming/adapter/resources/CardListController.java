...
import com.sy.board.management.command.board.usecase.CreateCardListCommand;
...
public class CardListController {
  ...
  @ApiOperation(value = "Create a card list by returning its id in the http header")

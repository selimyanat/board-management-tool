...
import com.sy.board.management.command.board.usecase.ArchiveBoardCommand;
import com.sy.board.management.command.board.usecase.CreateBoardCommand;
import com.sy.board.management.command.board.usecase.UpdateBoardNameCommand;
...
public class BoardController {
  ...
  @ApiOperation(value = "Create a board by returning its id in the http header")

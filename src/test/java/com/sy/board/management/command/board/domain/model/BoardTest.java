...
import com.sy.board.management.command.board.domain.model.cardlist.CardListAssert;
import com.sy.board.management.command.board.domain.model.cardlist.CardListCreatedEvent;
import com.sy.board.management.command.board.domain.model.cardlist.CardListCreatedEventAssert;
...
public class BoardTest {
  ...
  public void fromHistory_returns_board() {
    ...
    List<DomainEvent> history = List.of(
        ...
        BoardArchived.of(aBoardId, Status.ACTIVE)
    );

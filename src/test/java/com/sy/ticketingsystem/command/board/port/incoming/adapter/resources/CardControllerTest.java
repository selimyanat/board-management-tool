...
import static com.sy.ticketingsystem.command.board.port.incoming.adapter.resources.CardController.CARD_COMMAND_ROOT_URL;
...
import com.sy.ticketingsystem.command.board.usecase.CreateCardCommand;
...
public class CardControllerTest {
  ...
  public void createCard_is_successful() throws Exception {
    ...
    mockMvc.perform(post(CARD_COMMAND_ROOT_URL)
